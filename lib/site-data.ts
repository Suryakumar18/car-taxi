...
export const DEFAULT_DATA: SiteData = {
  ...
  navLinks: [
    ...
    { label: "Fleet", href: "#tariff" },
    { label: "Pricing", href: "#tariff" },
  ...
  footerColumns: [
    {
      ...
      links: [
        ...
        { label: "Taxi Fare & Pricing", href: "#tariff" },
        { label: "Available Cars", href: "#tariff" },
        { label: "One Way Taxi Service", href: "#services" },
    ...
    },
    {
      ...
      links: [
        { label: "Chennai to Madurai Taxi", href: "#book" },
        { label: "Chennai to Coimbatore Taxi", href: "#book" },
        { label: "Chennai to Bangalore Taxi", href: "#book" },
        { label: "Coimbatore to Cochin Taxi", href: "#book" },
        { label: "Madurai to Rameswaram Taxi", href: "#book" },
        { label: "Trichy to Thanjavur Taxi", href: "#book" },
      ],
    },
  ],
  footerBottom: "Fixed Fare • No Hidden Charges • 24/7 Booking Support",
  hero: {
    headline: "Book *One Way* Taxi Across *South India*",
    description:
      "Travel anywhere in Tamil Nadu, Kerala & Karnataka with reliable one way taxi service. Fixed fare, clean vehicles, and professional drivers for safe outstation and airport rides.",
    perks: ["Fixed Fare", "No Hidden Charges", "24/7 Booking Support", "Verified Drivers"],
    heroImage: "https://images.unsplash.com/photo-1495430288918-03be19c7c485?w=1920&q=80",
    heroImageFit: "screen" as const,
  },
  stats: [
  ...
  how: {
    ...
    steps: [
      { title: "Enter Route", desc: "Enter your pickup and drop city to get instant fare details." },
      { title: "Confirm Fare", desc: "Fixed price, no hidden charges. What we quote is what you pay." },
      { title: "Choose Time", desc: "Schedule your ride at any time based on your convenience." },
      { title: "Driver Assigned", desc: "A verified driver is assigned to your trip — on time, every time." },
    ],
  },
  why: {
    ...
    features: [
      { title: "Well Maintained Cars", desc: "Clean mini, sedan, SUV and traveller options for long distance travel." },
      { title: "Flexible Pickup", desc: "Schedule your ride anytime based on your convenience — early morning or late night." },
      { title: "Verified Drivers", desc: "Experienced drivers focused on safe and comfortable travel." },
      { title: "Wide Route Coverage", desc: "Serving major cities and destinations across South India." },
      { title: "Transparent Pricing", desc: "Fixed per-km pricing with no hidden charges or surge fares." },
      { title: "24/7 Booking Support", desc: "Call or WhatsApp us round the clock — real people confirm every booking." },
    ],
  },
  reviews: {
    kicker: "Testimonials",
    ...
    items: [
      { name: "Karthik R.", trip: "Chennai → Coimbatore", text: "On-time pickup and exact fare as quoted. Smooth long-distance ride. Highly recommended for outstation travel." },
      { name: "Divya S.", trip: "Madurai → Kodaikanal", text: "Driver handled hill roads well. Comfortable journey overall. Will definitely book again for family trips." },
      { name: "Sanjay V.", trip: "Bangalore → Salem", text: "Booked via WhatsApp, got quick confirmation and clean vehicle. Fixed fare with no surprises at the end." },
      { name: "Lakshmi P.", trip: "Trichy → Rameswaram", text: "Family trip was smooth. Good space for luggage and the driver was very professional throughout." },
      { name: "Arvind K.", trip: "Coimbatore → Kochi", text: "Reliable service for intercity travel. No hidden charges — exactly what was quoted is what I paid." },
    ],
  },
  faq: {
    kicker: "FAQ",
  ...
  routes: [
    ...
    { from: "Chennai", to: "Vellore", km: 140, time: "2h 30m", fare: 2750 },
    { from: "Chennai", to: "Tirupati", km: 135, time: "2h 30m", fare: 2750 },
    ...
    { from: "Coimbatore", to: "Kochi", km: 195, time: "3h 30m", fare: 4400 },
    { from: "Madurai", to: "Rameswaram", km: 170, time: "3h 00m", fare: 2990 },
    { from: "Madurai", to: "Kodaikanal", km: 120, time: "3h 00m", fare: 2750 },
    { from: "Trichy", to: "Thanjavur", km: 60, time: "1h 30m", fare: 2750 },
    { from: "Salem", to: "Bangalore", km: 230, time: "4h 00m", fare: 3920 },
  ],
  theme: {
    preset: "amber",
    defaultMode: "dark",
  ...
  trustBadges: ["Instant Booking", "24/7 Available", "Per KM Based", "Transparent Pricing"],
  ...
  destinationsHead: {
    kicker: "One Way Destinations",
    title: "One Way Taxi Destinations Across *Tamil Nadu, Kerala & Karnataka*",
    subtitle: "One way and outstation taxi services with transparent pricing and easy booking.",
  },
  destinations: [
    { name: "Chennai",      subtitle: "Airport & city travel",          type: "city",     image: "https://images.unsplash.com/photo-1582510003544-4d00b7f74220?w=600&q=80" },
    { name: "Bangalore",    subtitle: "Interstate business trips",       type: "business", image: "https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=600&q=80" },
    { name: "Coimbatore",   subtitle: "Industrial & city travel",        type: "business", image: "https://images.unsplash.com/photo-1486325212027-8081e485255e?w=600&q=80" },
    { name: "Madurai",      subtitle: "Temple & family trips",           type: "temple",   image: "https://images.unsplash.com/photo-1611516491426-03025e6043c8?w=600&q=80" },
    { name: "Rameswaram",   subtitle: "Pilgrimage travel",               type: "temple",   image: "https://images.unsplash.com/photo-1626968361222-291e74711449?w=600&q=80" },
    { name: "Tirupati",     subtitle: "Spiritual journeys",              type: "temple",   image: "https://images.unsplash.com/photo-1587474260584-136574528ed5?w=600&q=80" },
    { name: "Ooty",         subtitle: "Hill station rides",              type: "hill",     image: "https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?w=600&q=80" },
    { name: "Kodaikanal",   subtitle: "Scenic mountain travel",          type: "hill",     image: "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=600&q=80" },
    { name: "Munnar",       subtitle: "Nature & tea estates",            type: "hill",     image: "https://images.unsplash.com/photo-1594938298603-c8148c4b4adf?w=600&q=80" },
    { name: "Pondicherry",  subtitle: "Beach & leisure trips",           type: "coastal",  image: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600&q=80" },
    { name: "Kanyakumari",  subtitle: "Coastal long drives",             type: "coastal",  image: "https://images.unsplash.com/photo-1577720580479-7d839d829c73?w=600&q=80" },
    { name: "Alleppey",     subtitle: "Backwater travel",                type: "coastal",  image: "https://images.unsplash.com/photo-1593693397690-362cb9666fc2?w=600&q=80" },
    { name: "Cochin",       subtitle: "City & port travel",              type: "city",     image: "https://images.unsplash.com/photo-1598977123118-4e30ba3c4f5b?w=600&q=80" },
    { name: "Mysore",       subtitle: "Heritage & palace travel",        type: "city",     image: "https://images.unsplash.com/photo-1580674684081-7617fbf3d745?w=600&q=80" },
    { name: "Trichy",       subtitle: "Temple & city trips",             type: "city",     image: "https://images.unsplash.com/photo-1626968361222-291e74711449?w=600&q=80" },
    { name: "Thanjavur",    subtitle: "Heritage temple travel",          type: "temple",   image: "https://images.unsplash.com/photo-1587474260584-136574528ed5?w=600&q=80" },
    { name: "Salem",        subtitle: "Quick intercity travel",          type: "city",     image: "https://images.unsplash.com/photo-1495430288918-03be19c7c485?w=600&q=80" },
    { name: "Tirunelveli",  subtitle: "Long distance rides",             type: "city",     image: "https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=600&q=80" },
    { name: "Kutralam",     subtitle: "Waterfall trips",                 type: "scenic",   image: "https://images.unsplash.com/photo-1501854140801-50d01698950b?w=600&q=80" },
    { name: "Velankanni",   subtitle: "Pilgrimage & family travel",      type: "temple",   image: "https://images.unsplash.com/photo-1626968361222-291e74711449?w=600&q=80" },
  ],
};
...
export async function getSiteData(): Promise<SiteData> {
  try {
    ...
    return {
      ...
      destinationsHead: { ...DEFAULT_DATA.destinationsHead, ...doc.destinationsHead },
      destinations: doc.destinations?.length ? doc.destinations : DEFAULT_DATA.destinations,
      destinationsColumns: (doc.destinationsColumns as 1 | 2) ?? DEFAULT_DATA.destinationsColumns,
    };
  } catch (e) {
...
export async function saveSiteData(data: SiteData): Promise<void> {
  ...
  const {
    ...
    services, gallery, offer, tours, customThemes, destinationsHead, destinations, destinationsColumns,
  } = data;
